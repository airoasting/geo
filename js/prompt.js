...
## 평가 원칙
1. 반드시 web_search 도구를 사용하여 최신 정보를 수집하세요
2. 정보가 불확실하면 중간값(4-6점)을 사용하세요. 추측으로 극단값을 주지 마세요
3. 동일한 산업군 내 상대적 비교로 평가하세요
4. 한국 시장 기준으로 평가하되, 글로벌 브랜드는 글로벌 정보도 참조하세요
...
web_search 도구를 사용하여 이 브랜드의 최신 정보를 검색한 후 평가하세요.
